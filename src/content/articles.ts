...
Całe moje życie zaczynając od etapu szkolnego, przez okres nastoletni aż do teraz opiera się w mniejszym lub większym stopniu na sporcie. Jednak od zawsze prawdziwą podstawą tego były sporty drużynowe: piłka nożna, koszykówka, siatkówka … i zrobiłaby się z tego naprawdę bardzo długa lista. Jedną z konsekwencji tego skupienia się na aktywnościach zespołowych był strach, opór a może i lekka nienawiść do zwykłego samotnego biegania. 

**W poszukiwaniu wyzwań 🔍**

Jeszcze na początku zeszłego roku łączyłem przerzucanie żelastwa z towarzyskimi meczami na orlikach. Jednak uwielbiam prawdziwą rywalizację a nie dawało mi jej zwykłe kopanie i siłownia. Szukałem dla siebie alternatywy i tą dostałem na tacy.

**Pierwsza próba 🫢**

Otrzymałem wejściówkę na Bieg Europejski czyli 10km ulicami Gniezna. Podjąłem się go, mając z tyłu głowy wcześniejszy opór i tą niesłuszną nienawiść. Niestety, ta po tym biegu mogła się jedynie pogłębić przez moje bardzo kiepskie przygotowanie. Zrobiłem przed startem 3 jednostki treningowe, na których dałem z siebie dosłownie wszystko. Biegłem z maksymalnym HR na końcu czując się jak wrak. Nie dałem rady dokończyć 2 treningów, przed którymi zakładałem sobie przebiegnięcie 10km. Mój rezultat nie był za dobry 49:45, daleka pozycja w formule wiekowej. 

**Kolejna znów niezbyt udana próba ❌**

Bieganie odeszło w odstawkę na jakiś czas, aż pojawiła się kolejna okazja czyli półmaraton- Bieg Lechitów we wrześniu. Tutaj nastąpił mały przełom, poświęciłem trochę więcej czasu na przygotowania, zacząłem poznawać podstawy tego w jakich strefach biegać (dowiedziałem się, że w ogóle istnieją 😁) lecz nadal było to naprawdę amatorskie podejście.  Ten bieg również nie poszedł po mojej myśli mimo wielkich ambicji. Zacząłem za szybko w wysokiej temperaturze co bardzo szybko się na mnie odbiło. Zakończyłem z wynikiem 01:53:28. Na mecie czułem się fatalnie, przez odwodnienie i tak… znów to mizerne przygotowanie. 

**Zajawka i trochę wiedzy 💡**

Był to zapalnik, którego potrzebowałem. Bo kto by chciał zderzać się cały czas ze ścianą? Wiedziałem, że mogę poprawić swoje rezultaty, chciałem być w „topce” a nie gdzieś na szarym końcu tabeli. No i tu właściwie rozpoczęła się cała zajawka na bieganie oraz… o tym może w innym wpisie. Razem z Totalnymi Kotami pogłębialiśmy swoją wiedzę a z pomocą przyszedł plan treningowy Garmin. Ten pozwolił nam w bardzo szybkim tempie poprawić wyniki, uczył nas jak właściwie trenować oraz regenerować się przed kolejną jednostką. 

**Pierwsze efekty 🏃**

Po przepracowanych kilku tygodniach sprawdziłem się razem z Kubą na Biegu Niepodległości. Przebiegłem 10km w 42:02 a Woźny urwał jeszcze parę sekund kończąc odpowiednio na 6 i 7 miejscu w naszej kategorii. Kolejne parę tygodni treningów i tym razem już cała ekipa Totalnych Kotów podbija HM. Wyciskamy na śniegu czas 01:40:23. Mija parę dni, podczas których, rodzi się pomysł by spróbować złamać magiczną barierę 20 minut na 5km i robimy to z małym zapasem 19:23. 

**Odczucia i małe podsumowanie 🤝**

Uczucie jakie towarzyszy przekraczaniu własnych granic i podbijania swoich czasów jest niezastąpione, ciężko je do czegoś porównać. Życzę każdemu by mógł go doświadczać, najlepiej bardzo często. Na koniec rodzą się pytania: czy parę miesięcy wcześniej pomyślałbym o 4 jednostkach biegania w tygodniu? Uwierzyłbym, że będę startował w wyścigach? Odpowiedź jest jedna 😃 Jestem wdzięczny. Bieganie dało mi olbrzymie pokłady pewności siebie oraz dyscypliny, której w tych czasach każdy z nas potrzebuje. Oczywiście to nie jedyny efekt biegania, który zauważyłem. Pomijając aspekt zdrowia fizycznego, przebieżki pozwalają mi zadbać o moje zdrowie psychiczne. A jakie były Twoje początki biegania? Co było Twoim zapalnikiem?
`;
...
- Co dla Ciebie dokładnie oznacza sukces?
...
Postanowiłem, że spiszę cały mój rok, moje osiągnięcia, moje cele, zarówno te zrealizowane, jak i te, które były lekcją. Moje sukcesy i porażki, wzloty i upadki. Myślę, że warto wylać to wszystko, co siedzi w głowie i utrwalić to na medium, z którego będę mógł to przeczytać za jakiś czas. Ostatnio zrobiłem to samo z moim notatnikiem, który prowadzę od 2021 roku, i to niesamowite, jak zmieniły się moje procesy myślowe i to, jak zmieniło się moje życie.

Okej, ale dlaczego po tym, jak skończyłem pisać to w Notion, postanowiłem wrzucić to tutaj? Szczerze uważam, że mogę kogoś zainspirować do działania, że może kogoś natchnie po przeczytaniu tego, aby ruszyć się trochę od komputera, zrobić coś innego, coś, co było odkładane przez długi czas.

## Sport

Sport odgrywa w moim życiu ogromną rolę. Nie było tak zawsze, powiem nawet więcej, że nie było tak przez większość mojego życia. Rozpoczynając ten rok, moimi celami sportowymi było wziąć udział w zawodach boulderowych oraz przebiec 1000km. Tak jak udało mi się wziąć udział nawet w 2 zawodach, tak przez pierwsze 6 miesięcy przebiegłem zaledwie 100km i porzuciłem cel. Na chwilę.

### Bouldering

Pierwsze 3 miesiące 2023 roku były skoncentrowane prawie w 100% na wspinaczce. Nie było wtedy jeszcze myśli o triathlonie, realizacji celu biegowego czy czymkolwiek innym. Wziąłem nawet udział w dwóch zawodach, które kończyłem na ostatnich miejscach - mimo to bawiłem się świetnie, a rywalizacja oraz chęć lepszego wspinania się sprawiły, że te rezultaty tylko mnie motywowały. Niestety, wraz z tym, jak moje skupienie przeszło w 100% na przygotowania do triathlonu, przestałem regularnie się wspinać i na ten moment nie mam planu, aby wrócić.

### Triathlon

Na jednym ze spotkań u mojej dziewczyny, ktoś rzucił, że bierze udział w triathlonie, konkretniej na dystansie 1/4 całości. A ja, lubiąc wyzwania, pomyślałem sobie: *“1/4? Co to takiego, też wezmę udział, a może nawet od razu spróbuję dystans 1/2”*. **Gdybym tylko wtedy wiedział, że to nie jest takie łatwe**. W każdym razie, szczęśliwym trafem zdecydowałem się na 1/4 (950m pływania, 40km roweru oraz 11km biegu).

Z perspektywy czasu wiem, że moje przygotowania były słabe. W trakcie “przygotowań” mój najdłuższy bieg to było 12km i pobiegłem tak **jeden raz**, reszta to były 5km przebieżki. Wtedy wydawało mi się, że szykuję się w miarę okej. Nie było tak - moje przygotowania były słabe. Głównym powodem był brak wiedzy oraz fakt, że byłem chyba zbyt pewny siebie.

Jeśli chodzi o przygotowanie od strony rowerowej, to też szału nie było. Parę razy pojechałem na trasy około 50/60km. Zero interwałów, zero patrzenia na strefy tętna czy jakiegokolwiek planu.

Im bliżej były zawody, tym bardziej klarował mi się jednak wynik, którego mogę się spodziewać. Co parę dni wchodziłem na kalkulator triathlonowy i wyliczałem, jakiego tempa mogę się spodziewać na podstawie osiąganych wyników. Z moich kalkulacji niedługo przed zawodami wyszło mi, że mogę spróbować zmieścić się w **3 godzinach**, więc taki właśnie czas obrałem sobie za cel.

Pamiętam, że przed rozpoczęciem etapu biegowego wszystko miałem "pod kontrolą". Moje ciągłe zerkanie na zegarek podczas etapu rowerowego pokazało, że miałem o wiele lepszy czas niż zakładałem. W biegu wyszedłem z nierealistycznym tempem około 4:30/km, które już na pierwszym kilometrze spadło do 5:10/km. Do piątego kilometra jakoś to jeszcze trzymało się w ryzach, ale później? Mój szósty i ósmy kilometr pokonałem w tempie 6:18/km i 6:35/km. Dotarłem do ściany - powodów pewnie jest sporo, poza moim słabym przygotowaniem to rażące 30 stopni nie pomagało.

Po biegu, w sporym bólu w lewym kolanie, które w tamtym czasie często o sobie przypominało, wbiegłem na metę z czasem **2:58:48**.
...
Część pływacką z triathlonu, zwłaszcza z nurtem rzeczki, wspominam świetnie. Dlatego, jak tylko usłyszałem o organizowanych zawodach pływackich w Brdzie, stwierdziłem, że muszę wziąć udział. Wybrałem dystans średni - 1600m, z czego spora część była pod prąd.

Już po samym wskoczeniu do wody zgubiłem urządzenie do mierzenia czasu, a po nawrocie, z którego zaczynało się płynać pod prąd, miałem problemy, żeby poruszać się w górę rzeki. Po paru minutach walki dostałem się na wysokość, gdzie nurt był neutralny, i dopłynąłem do końca z poniżej przeciętnym czasem **00:39:00**. Nie byłem zadowolony z tego wyniku, ale też nie spodziewałem się czegoś lepszego.

To była kolejna lekcja, żeby lepiej przygotowywać się do takich eventów i podchodzić do tych wyzwań z większą pokorą.

### Przejażdżki rowerowe

W 2023 roku przejechałem na rowerze **1667km**. Część z tego wykręciłem na trenarze w domu, ale zdecydowana większość to ciężkie pedałowanie na 6-letnim góralu.

Zdecydowanie najbardziej jestem zadowolony z trasy Bydgoszcz → Poznań, którą z Maurycym pokonaliśmy w około **10 godzin**. Plecaki były wypełnione po brzegi wodą i batonami. Na 60km dotarłem do ściany, którą pokonałem batonem bananowym i do końca trasy nie było już większych problemów, choć na takim rowerze i z takim obciążeniem średnie tempo było niesamowicie męczące. To wyzwanie, poza aspektem fizycznym, miało też dla mnie duży aspekt mentalny. To jednak prawie połowa dnia pedałowania, gdzie przy zabójczych 17km/h końca nie widać. Jednak prawdziwe mentalne wyzwanie dopiero na mnie czekało.
...
W 2023 roku nie zabrakło też dwóch okazji do spróbowania się w Runmageddonie.

Pierwszy bieg w kwietniu był tzw. rekrutem, czyli **6km i 30 przeszkód**. Był to też bieg, w którym wiedziałem, że mam "nierozwiązane porachunki" z jedną przeszkodą z zeszłego roku. Jakby powiedział to Michael Jordan - "I took it personally". W tym roku przeszedłem ją bez problemu. Ten bieg biegliśmy w pełnym składzie Totalnych Kotów i skończyliśmy z bardzo dobrym czasem. Po tym biegu pozostał spory niedosyt i wiedziałem, że to był ostatni tak krótki dystans.
...
W tym roku po raz pierwszy zdobyłem szczyty polskich gór. Choć nigdy wcześniej nie przyciągały mnie takie wyzwania, jednak teraz jestem niezmiernie zadowolony, że zdecydowałem się na takie doświadczenie.
...
Na bieganie poświęciłem w tym roku około 100 godzin oraz **przebiegłem 1002km**. Tym samym zrealizowałem swój cel z początku roku. Wbrew pozorom, mój milaż nie rósł liniowo od początku roku - jak pisałem wyżej, przez pierwsze 5 miesięcy przebiegłem tylko **94km**. Wtedy już stwierdziłem, że ten cel porzucam, bo nie ma sensu i zrealizowanie go byłoby bardzo trudne. Z takim nastawieniem byłem aż do połowy listopada, gdzie spojrzałem jeszcze raz na przebiegnięty dystans i naszła mnie myśl - mogę to zrobić.
...
Jednak patrząc na ten plan, jedno rzuca się w oczy: zaplanowany na 29 grudnia maraton. Czy dobrym pomysłem jest podjęcie maratonu dwa dni przed końcem roku, kiedy wcześniej najwięcej przemierzyłem pół tego dystansu? Niekoniecznie, ale to kolejny cel, który postawiłem sobie kilka tygodni wcześniej - wraz z przebiegnięciem półmaratonu i 5km.

W skrócie opiszę wszystkie znaczące biegi tego roku. O samym biegu na 42km mógłbym napisać oddzielny wpis, więc to będą głównie fragmenty.

- Maraton - Przyszedłem na ten bieg ze świetnym nastawieniem. Nie był to żaden zorganizowany event, tylko ja i Woźny. Na 30km pojawiła się ściana, którą myślałem, że zmusi mnie do przejścia tych pozostałych 12km. Na szczęście udało się przejść przez ten kryzys i mogłem wrócić do biegu z tempem około 5:50min/km. Ostatnie 8km to jedne z najmniej przyjemnych chwil w tym roku. Ból w udach, łydkach, podwyższone tętno mimo wolniejszego tempa, cięższy oddech, technika biegu tragiczna - o ile można to jeszcze nazwać biegiem. Mam nadzieję, że w Marcu będzie tak samo - tylko szybciej 🙂
- Bieg Niepodległości 10km - był to bieg, do którego szykowałem się przez około 10 tygodni. Był to ten blok treningowy, który zaczął się po drugim Runmageddonie, po którym stwierdziłem, że muszę lepiej biegać. Celem było pobiec **poniżej 45 minut - 4:30min/km**. Na metę przybiegłem z czasem **44:24** - wnioskiem z tego biegu było to, żeby nie startować za 3 tysiącami ludzi i że mogłem pewnie mocniej pocisnąć początek biegu. Na mecie pierwszy raz zarejestrowałem tętno 202 uderzeń na minutę.
...
Praca, w ogólnym pojęciu, to inny ważny aspekt mojego życia. W tym roku nauczyłem się podejścia, które mam zamiar wdrażać przez następne lata - jest to dostarczanie **wartości**. Zależało mi na tym, aby moja praca przynosiła wartość. Chciałem, aby ktoś po obejrzeniu mojego filmu czuł, że nie zmarnował tego czasu.
...
W 2023 napisałem 3 artykuły na temat web developmentu, z czego na moim blogu pojawiły się tylko 2. Nie osiągnąłem swojego celu o 10 sztuk. Tak samo nie osiągnąłem celu 10 tysięcy wyświetleń moich wpisów i finalnie liczba ta osiągnęła niecałe 2 tysiące. Myślę, że największym problemem było to, że sam nie czułem się do końca przekonany o czym chcę pisać. Bardzo ciągnęło mnie do tematyki skupionej nie na samym kodzie, a na tworzeniu własnych projektów, narzędzi, produktywności w pracy itd. W 2024 spędzę zdecydowanie więcej czasu na pisaniu i tworzeniu treści - być może będą to treści o takiej właśnie tematyce.

### Konsultacje

W tym roku udzieliłem też około 10 darmowych konsultacji dotyczących programowania webowego. Większość osób znajdywała moje linki do Calendly (platforma do umawiania spotkań) w opisach filmów na YouTube, gdzie mogła dodać spotkanie w moim kalendarzu. W ten sposób poznałem wiele ciekawych osób, oraz ich problemy. A przede wszystkim większości byłem w stanie pomóc - po to tak naprawdę to robiłem.

### Projekty

To raczej jedna z rzeczy, którymi nie ma czym się chwalić, ale mogę z niej wyciągnąć pewne wnioski - w tym roku pracowałem przynajmniej nad 6 projektami (aplikacjami internetowymi) które chciałem wypuścić do ogólnego użytku. Niektóre z nich miały już porozpisywane todosy, a kilka miało nawet gotowy design. Jednak nie doprowadziłem do końca ani jednego.

Czy to oznacza, że straciłem tylko swój czas? Nic bardziej mylnego. W trakcie tych projektów nauczyłem się mnóstwa rzeczy i niczego nie żałuję. Mimo wszystko zdałem sobie sprawę, że mam problem z **dokańczaniem rzeczy.** Parę miesięcy później zdałem sobie sprawę, że większość ludzi ma z tym problem.

Zrozumiałem, że jeśli projekt będzie wymagał dużo zaangażowania i czasu, to tworzenie go musi być motywowane czymś innym niż aktualnym *hypem czy ekscytacją* nad swoim pomysłem, bo przyjdą ściany i ciężko będzie się przez nie przebić bez dobrych powodów.

### Zmiana pracy

Ostatnią dużą rzeczą która wydarzyła się u mnie pod koniec roku to zmiana firmy. Nie mogę się doczekać aż dołączę do nowego zespołu. Nowa praca w tym przypadku to dużo nowych wyzwań - nowa technologia której muszę się nauczyć prawie od zera, praca w innej organizacji która na pewno działa inaczej. Can’t wait!

Dodatkowo, coś, co nie wpasowywało się w kategorię sportu czy pracy, a z czego jestem bardzo dumny, to fakt, że przez cały rok nie spożywałem alkoholu. Świadomy jego szkodliwości i braku jakichkolwiek korzyści, postanowiłem ograniczyć jego spożycie do zera i planuję utrzymać to samo postanowienie w 2024 roku.

## Podsumowanie

Ten rok był bardzo dobry, zrobiłem w nim ogrom fajnych rzeczy a co najważniejsze - przy tym wszystkim z **uśmiechem na twarzy** i **ciesząc się z każdej chwili**. Będąc wdzięcznym za to, że mogę wieść takie życie, za to, że mogę wstawać do pracy, którą lubię, za to, że mogę biegać czy za to, że mogę odkrywać kolejne granice i pokonywać je.

Ten rok to była bardzo duża lekcja.

Oby 2024 rok był tak samo dobry albo lepszy i tego **życzę też Tobie**, mam nadzieję, że ten wpis w chociaż w małym stopniu zainspirował Cię i popchnie Cię do zmian na lepsze.
`;
